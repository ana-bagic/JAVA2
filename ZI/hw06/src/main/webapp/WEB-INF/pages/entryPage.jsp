...
<body>
	...
	<form
		action="<c:url value="/servleti/author/${NICK}/${ENTRY.id}"></c:url>"
		method="post">
		<div>
			<label for="usersEMail">Your email:</label> <input type="text"
				id="usersEMail" name="usersEMail" value="${COMMENT.usersEMail}">
